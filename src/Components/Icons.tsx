...
export function ArrowDownIcon(props:typeProps) {
  ...
  export function HomeIcon(props:typeProps) {
    return (
    <svg id="Group_7" data-name="Group 7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" className={props.edit}>
  ...
  export function SearchIcon(props:typeProps) {
    return (
      <svg id="Group_212" data-name="Group 212" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28.534 28.543" className={props.edit}>
        <g id="layer1">
  ...
  export function UserIcon(props:typeProps) {
    return (
      <svg  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 35.964 43.107" className={props.edit}>
